...
public class ModuleRegistryGenerator : IIncrementalGenerator
{
    ...
    private static string GenerateModuleRegistry(string? targetNamespace, ImmutableArray<ModuleInfo> modules)
    {
        ...
        sb.AppendLine($"{indent}    /// To access all modules, resolve IEnumerable&lt;IModule&gt; from the service provider:");
        sb.AppendLine($"{indent}    /// </remarks>");
        ...
        sb.AppendLine($"{indent}    {{");
        sb.AppendLine($"{indent}        IModule[] modules =");
        sb.AppendLine($"{indent}        [");
        ...
        sb.AppendLine($"{indent}            {{");
        sb.AppendLine($"{indent}                Console.WriteLine($\"Registering module '{{module.Name}}'...\");");
        sb.AppendLine($"{indent}                module.Register(services, configuration);");
        sb.AppendLine($"{indent}                services.AddSingleton<IModule>(module);");
        sb.AppendLine($"{indent}            }}");
        sb.AppendLine($"{indent}            catch (Exception ex)");
        sb.AppendLine($"{indent}            {{");
        sb.AppendLine($"{indent}                Console.WriteLine($\"Error registering module '{{module.Name}}': {{ex.Message}}\");");
        ...
        sb.AppendLine($"{indent}        IConfiguration configuration)");
        sb.AppendLine($"{indent}    {{");
        sb.AppendLine($"{indent}        var modules = app.ApplicationServices.GetServices<IModule>();");
        sb.AppendLine($"{indent}        var logger = app.ApplicationServices.GetRequiredService<ILogger<IModule>>();");
        sb.AppendLine();
        sb.AppendLine($"{indent}        foreach (var module in modules)");
        sb.AppendLine($"{indent}        {{");
        sb.AppendLine($"{indent}            try");
        sb.AppendLine($"{indent}            {{");
        sb.AppendLine($"{indent}                logger.LogInformation(\"Configuring module '{{ModuleName}}'...\", module.Name);");
        sb.AppendLine($"{indent}                module.Use(app, configuration);");
        sb.AppendLine($"{indent}            }}");
        sb.AppendLine($"{indent}            catch (Exception ex)");
        sb.AppendLine($"{indent}            {{");
        sb.AppendLine($"{indent}                logger.LogError(ex, \"Error configuring module '{{ModuleName}}'\", module.Name);");
        sb.AppendLine($"{indent}                throw;");
        sb.AppendLine($"{indent}            }}");
        sb.AppendLine($"{indent}        }}");
        sb.AppendLine();
        ...
        sb.AppendLine($"{indent}    {{");
        sb.AppendLine($"{indent}        var modules = serviceProvider.GetServices<IModule>();");
        sb.AppendLine($"{indent}        var logger = serviceProvider.GetRequiredService<ILogger<IModule>>();");
        sb.AppendLine();
        sb.AppendLine($"{indent}        foreach (var module in modules)");
        sb.AppendLine($"{indent}        {{");
        sb.AppendLine($"{indent}            try");
        sb.AppendLine($"{indent}            {{");
        sb.AppendLine($"{indent}                logger.LogInformation(\"Initializing module '{{ModuleName}}'...\", module.Name);");
        sb.AppendLine($"{indent}                await module.Initialize(serviceProvider, cancellationToken);");
        sb.AppendLine($"{indent}            }}");
        sb.AppendLine($"{indent}            catch (Exception ex)");
        sb.AppendLine($"{indent}            {{");
        sb.AppendLine($"{indent}                logger.LogError(ex, \"Error initializing module '{{ModuleName}}'\", module.Name);");
        sb.AppendLine($"{indent}                throw;");
        sb.AppendLine($"{indent}            }}");
        sb.AppendLine($"{indent}        }}");
        sb.AppendLine($"{indent}    }}");
